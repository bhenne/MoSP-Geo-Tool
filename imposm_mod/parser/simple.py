...
from imposm_mod.parser.util import default_concurrency, fileinput, setproctitle
...
class OSMParser(object):
    ...
    def parse_pbf_file(self, filename):
        ...
        Parse a PBF file.
        """
        from imposm_mod.parser.pbf.multiproc import PBFMultiProcParser
    ...
    def parse_xml_file(self, filename):
        ...
        """
        from imposm_mod.parser.xml.multiproc import XMLMultiProcParser
    ...
    def _parse(self, input, parser_class):
        ...
        if self.bounds_callback:
            ...
            queues_callbacks['bounds'] = (multiprocessing.JoinableQueue(128),
