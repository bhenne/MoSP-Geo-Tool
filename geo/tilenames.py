""" Translates between lat/long and the U{slippy-map tile numbering scheme<http://wiki.openstreetmap.org/index.php/Slippy_map_tilenames>}

@author: Oliver White
@see: taken from U{http://svn.openstreetmap.org/applications/routing/pyroute/tilenames.py}
